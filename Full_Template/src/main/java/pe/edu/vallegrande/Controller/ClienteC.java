...
public class ClienteC implements Serializable {
    ...
    public void actualizar() {
        try {
            daoCliente.modificar(clienteSeled);
            FacesContext.getCurrentInstance().addMessage(null,
    ...
    public List<Cliente> getSelectCliente() {
        return selectCliente;
    }

    public void setSelectCliente(List<Cliente> selectCliente) {
        this.selectCliente = selectCliente;
    }

    public Cliente getClienteSeled() {
        return clienteSeled;
    }

    public void setClienteSeled(Cliente clienteSeled) {
        this.clienteSeled = clienteSeled;
    }
